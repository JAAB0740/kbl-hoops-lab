  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <span className="text-[14px] uppercase tracking-wider text-ink-500">스탯 모드</span>
          ...
          {(["basic", "advanced", "hustle"] as Mode[]).map((m) => {
            ...
            return (
              <button
                ...
                onClick={() => setMode(m)}
                className={[
                  "rounded-md px-3 py-1 text-[15px] font-medium transition",
                  active
    ...
    <div className="overflow-hidden rounded-lg border border-court-700/70">
      <div className="flex items-center justify-between gap-2 bg-court-900/70 px-3 py-2">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[13px] uppercase tracking-wider text-ink-500">
            {side === "home" ? "홈" : "원정"}
          </span>
        </div>
