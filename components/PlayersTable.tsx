      ...
      <div className="mb-4 space-y-2">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            <label className="text-[14px] uppercase tracking-wider text-ink-500">검색</label>
            <input
              value={search}
              onChange={(e) => setSearch(e.target.value)}
              placeholder="이름 (한글/영문)"
              className="w-44 rounded-md border border-court-700 bg-court-800 px-2.5 py-1.5 text-[16px] text-ink-100 placeholder:text-ink-500 focus:border-flame-500 focus:outline-none"
            />
          </div>
          <div className="ml-auto text-[14px] text-ink-500">
...
function ChipFilterRow({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <span className="w-16 shrink-0 text-[14px] uppercase tracking-wider text-ink-500">
        {label}
      </span>
...
function FilterSelect({
  ...
  return (
    <div className="flex items-center gap-2">
      <label className="text-[14px] uppercase tracking-wider text-ink-500">{label}</label>
      <select
        value={value}
        onChange={(e) => onChange(e.target.value)}
        className="rounded-md border border-court-700 bg-court-800 px-2.5 py-1.5 text-[16px] text-ink-100 focus:border-flame-500 focus:outline-none"
      >
