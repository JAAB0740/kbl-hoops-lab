      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="flex h-14 items-center justify-between">
            ...
            <nav className="hidden items-center gap-1 md:flex">
              {NAV.map((item) => (
                <Link
                  ...
                  href={item.href}
                  className={[
                    "rounded-md px-3 py-1.5 text-[16px] font-medium transition-colors",
          ...
          <div className="flex items-center gap-3">
            <span className="hidden text-[14px] font-medium tracking-widest text-ink-500 sm:inline">
              2025-26 정규리그
            </span>
            <div className="flex items-center gap-1.5 rounded-md border border-court-700 bg-court-800/70 px-2.5 py-1.5">
              ...
              <span className="text-[14px] font-medium text-ink-100">{status.shortChip}</span>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center gap-1 px-3 py-2 whitespace-nowrap">
            {NAV.map((item) => (
              <Link
                ...
                href={item.href}
                className={[
                  "shrink-0 rounded-md px-2.5 py-1 text-[15px] font-medium transition-colors",
                  isActive(pathname, item.href)
