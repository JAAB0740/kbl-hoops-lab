          ...
          const inner = (
            <>
              ...
              <div className="min-w-0 flex-1">
                <p className="line-clamp-2 text-[16px] font-medium leading-snug text-ink-100 transition group-hover:text-flame-400">
                  {h.title}
                </p>
                <p className="mt-1 text-[14px] text-ink-500">{h.time}</p>
              </div>
            </>
          );
            ...
            >
              ...
              {h.searchQuery && (
                <a
                  ...
                  className="shrink-0 inline-flex h-6 w-6 items-center justify-center rounded-md border border-court-700 bg-court-800/70 text-[14px] text-ink-400 transition hover:border-[#03C75A]/50 hover:bg-[#03C75A]/10 hover:text-[#03C75A]"
