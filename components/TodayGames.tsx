        ...
        {games.map((g) => (
          ...
          >
            <div className="flex flex-col items-end">
              <span className="text-[16px] font-semibold text-ink-50">
                {g.home.name}
              </span>
              <span className="text-[14px] text-ink-500">HOME</span>
            </div>
            ...
            <div className="flex flex-col items-center gap-1 px-3">
              ...
              <span className="chip border-flame-500/30 bg-flame-500/10 px-2 py-0.5 text-[13px] text-flame-400">
                {g.tag}
              </span>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[14px] text-ink-500">AWAY</span>
            </div>
          </li>
        ))}
      </ul>
