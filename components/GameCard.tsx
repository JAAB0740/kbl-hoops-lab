...
function FormPill({ form }: { form: ("W" | "L")[] }) {
  if (form.length === 0) {
    return <span className="text-[10px] text-ink-500">최근 폼 없음</span>;
  }
  return (
        ...
        <div className="border-t border-court-700/60 bg-court-900/40 p-4">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div className="md:text-right">
              ...
              <div className="mt-2 flex items-center gap-2 text-[11px] text-ink-400 md:justify-end">
          ...
          <div className="mt-4 flex justify-end">
            <Link
              ...
              className="rounded-md border border-flame-500/40 bg-flame-500/10 px-3 py-1.5 text-[12px] font-medium text-flame-400 hover:bg-flame-500/20"
            >
              경기 상세 →
            </Link>
          </div>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 min-w-0">
        ...
        />
        <span className="text-[10px] font-medium uppercase tracking-wider text-ink-500 w-7 shrink-0">
          {isHome ? "홈" : "원정"}
        </span>
        <span
