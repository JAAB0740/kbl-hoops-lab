  ...
  return (
    <div className="card overflow-hidden">
      ...
      <div className="border-t border-court-700/60">
        <div className="px-5 py-3 text-[10px] font-medium uppercase tracking-[0.12em] text-ink-500">
          1차 (정규시즌 평균)
        </div>
        ...
        {t.advanced && b.advanced && (
          <>
            <div className="px-5 pt-2 text-[10px] font-medium uppercase tracking-[0.12em] text-ink-500">
              2차 (Advanced)
            </div>
            <div className="divider-y px-5 pb-4">
              {ADV_ROWS.map((r) => {
        ...
        {hasPo && (
          <>
            <div className="border-t border-court-700/60 px-5 py-3 text-[10px] font-medium uppercase tracking-[0.12em] text-flame-400">
  ...
  return (
    <div className="px-5 py-4 text-center">
      <div className="flex items-center justify-center gap-2">
        {seed != null && (
          <span
            className="stat-num inline-flex h-6 w-6 items-center justify-center rounded text-[11px] font-bold"
      ...
      <div className="stat-num mt-1 text-[12px] text-ink-300">{record}</div>
    </div>
  );
}
...
function CompareRow({
  ...
  return (
    <div className="grid grid-cols-[1fr_60px_1fr] items-center gap-3 py-2">
      ...
      <div className="text-center text-[10px] uppercase tracking-[0.1em] text-ink-500">
        {label}
      </div>
      <div
        className={[
          "stat-num text-left text-[13px]",
