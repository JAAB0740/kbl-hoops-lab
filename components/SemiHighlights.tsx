    ...
    <div className="card overflow-hidden">
      <div className="border-b border-court-700/60 bg-court-800/40 px-5 py-4">
        <div className="flex items-baseline justify-between gap-2">
          ...
          <a
            href="/playoffs"
            className="text-[14px] text-ink-500 hover:text-flame-400"
          >
            브래킷 →
          </a>
        </div>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        {seed != null && (
          <span
            className="stat-num inline-flex h-5 w-5 items-center justify-center rounded text-[13px] font-bold"
            style={{
