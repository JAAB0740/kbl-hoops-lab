...
export function TeamFourFactors({
  ...
  return (
    <div className="card p-5">
      ...
      {/* 헤더 */}
      <div className="mb-2 grid grid-cols-[110px_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)] gap-3 px-1 text-[12px] uppercase tracking-wider text-ink-500">
        <span>팀</span>
        <FactorHeader
          name="eFG%"
          desc="슈팅 효율"
...
function FactorHeader({
  ...
  return (
    <div>
      ...
      <div className="text-[12px] normal-case tracking-normal text-ink-600">
