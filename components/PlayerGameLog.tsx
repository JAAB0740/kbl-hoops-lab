...
export function PlayerGameLog({
  ...
  return (
    <div className="card p-5">
      ...
      {/* 필터별 평균 요약 */}
      {avg && mode === "basic" && (
        <div className="mb-3 flex flex-wrap gap-4 rounded-md border border-court-700/60 bg-court-900/40 px-3 py-2 text-[13px]">
      ...
      <div className="overflow-x-auto rounded-lg border border-court-700/70">
        <table className="w-full text-[13px]">
          <thead>
            <tr className="bg-court-900/70 text-[12px] uppercase tracking-wider text-ink-500">
              <SortableHead
