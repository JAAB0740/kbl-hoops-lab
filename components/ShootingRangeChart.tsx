  ...
  return (
    <div className="card p-5">
      <div className="flex items-baseline justify-between gap-2">
        ...
        <div className="text-right text-[14px] text-ink-500">
        ...
        {regular.map((r) => {
          ...
          return (
            <div key={r.range} className="space-y-1">
              <div className="flex items-baseline justify-between gap-2">
                <span className="text-[15px] font-medium text-ink-100 inline-flex items-center gap-1.5">
                  <span
                ...
                <span className="stat-num text-[15px]">
