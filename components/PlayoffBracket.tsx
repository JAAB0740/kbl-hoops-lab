...
function SeriesBox({
  ...
  if (!series) {
    return (
      <div className="card flex h-full flex-col justify-center p-3 text-center text-[12px] text-ink-500">
        매치업 미정
      </div>
    );
  }
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        {stateChip}
        <span className="stat-num text-[11px] text-ink-500">
      ...
      {/* 챔피언 표시 */}
      {isFinal && champion && (
        <div className="mt-1 flex items-center justify-center rounded-md bg-gradient-to-r from-flame-500/20 via-flame-500/30 to-flame-500/20 py-1.5 text-[12px] font-semibold text-flame-400">
          🏆 {champion} 우승
        </div>
      )}
    </button>
    ...
    >
      <div className="flex min-w-0 items-center gap-2">
        {seed != null ? (
          <span
            className={[
              "stat-num inline-flex h-5 w-5 flex-none items-center justify-center rounded text-[11px] font-bold",
              isWinner
          ...
          <span className="stat-num inline-flex h-5 w-5 flex-none items-center justify-center rounded bg-court-700/40 text-[11px] text-ink-500">
            ·
          </span>
        )}
        <span
      ...
      <span
        className={[
          "stat-num ml-2 inline-flex h-6 min-w-6 flex-none items-center justify-center rounded px-1.5 text-[13px] font-bold",
          isWinner
...
function GameRow({
  ...
  return (
    ...
    >
      <div className="flex flex-col">
        <span className="text-[12px] font-medium uppercase tracking-[0.1em] text-ink-500">
          G{game.no}
        </span>
        <span className="stat-num text-[12px] text-ink-300">{dateLabel}</span>
      </div>
