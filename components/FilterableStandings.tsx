  ...
  return (
    <div className="card p-5">
          ...
          {(Object.keys(FILTER_META) as Filter[]).map((f) => {
            ...
            return (
              <button
                ...
                onClick={() => setFilter(f)}
                className={[
                  "rounded px-3 py-1.5 text-[14px] font-medium transition",
                  active
      ...
      {biggestMover && biggestMover.delta !== 0 && (
        <div className="mb-3 rounded-md border border-court-700/60 bg-court-900/40 px-3 py-2 text-[14px] text-ink-300">
