    ...
    <>
      ...
      <div className="card mb-4 p-5">
        ...
        <div className="space-y-2">
            ...
            {isRoundMode && (
              <>
                <button
                  ...
                  className="rounded-md border border-court-700 bg-court-800/30 px-2.5 py-1.5 text-[11px] text-ink-400 hover:border-court-500 hover:text-ink-100"
                >
                  전체 선택
                </button>
                <button
                  onClick={() => setRoundSet(new Set())}
                  className="rounded-md border border-court-700 bg-court-800/30 px-2.5 py-1.5 text-[11px] text-ink-400 hover:border-buzzer-500/50 hover:text-buzzer-400"
                >
                  해제
                </button>
              </>
          ...
          {isRoundMode && (
            <p className="ml-14 text-[11px] text-ink-500">
                    ...
                    return (
                      ...
                      >
                        ...
                        {statMode === "traditional" ? (
                          ...
                          <td colSpan={8} className="stat-num py-2.5 text-center text-[11px] text-ink-500">
