      ...
      <div className="relative px-6 py-6">
        ...
        <div className="flex flex-wrap items-start justify-between gap-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 text-[13px] font-medium uppercase tracking-[0.12em] text-ink-500">
              ...
              <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-1 stat-num text-[14px] text-ink-300">
          ...
          {season && (
            <div className="flex items-baseline gap-1">
              <span className="text-[13px] uppercase tracking-[0.12em] text-ink-500">
                정규 평균
              </span>
...
function Meta({ label, value }: { label: string; value: string }) {
  return (
    <div>
      ...
      <div className="mt-0.5 text-[15px] font-medium text-ink-100">{value}</div>
    </div>
  );
}
...
function BigStat({
  ...
  return (
    <div className="relative overflow-hidden card p-4">
      ...
      {subtitle && (
        <div className="mt-1 text-[13px] text-ink-300">{subtitle}</div>
      )}
    </div>
  );
}
...
function ShootingPanel({ row }: { row: PlayerDetailRow | null }) {
  if (!row) return <div className="card p-5 text-[15px] text-ink-500">정규 시즌 데이터 없음</div>;
  return (
    <div className="card p-5">
      <h3 className="text-sm font-semibold tracking-tight text-ink-50">
        슈팅 효율 — 정규 시즌
      </h3>
      <p className="mt-1 text-[13px] text-ink-500">경기당 평균</p>
  ...
  return (
    <div>
      <div className="flex items-baseline justify-between">
        <span className="text-[14px] text-ink-300">{label}</span>
...
function MiniStat({ label, value }: { label: string; value: string }) {
  return (
    <div>
      ...
      <div className="mt-0.5 text-[12px] uppercase tracking-wider text-ink-500">
        {label}
      </div>
    </div>
  );
    ...
    <div className="card p-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-[13px] text-ink-500">정규시즌 1~6라운드</p>
        </div>
        <div className="flex flex-wrap gap-1">
          {TREND_OPTIONS.map((o) => (
            <button
              ...
              className={[
                "rounded-md border px-2 py-1 text-[13px] transition",
                statKey === o.key
      ...
      <div className="mt-4" style={{ width: "100%", height: 240, minWidth: 0 }}>
        {hasData ? (
          ...
          <div className="flex h-full items-center justify-center text-[14px] text-ink-500">
            라운드 데이터 없음
          </div>
        )}
      </div>
    ...
    <div className="card p-5">
      ...
      <div className="mt-4 overflow-hidden rounded-md border border-court-700/60">
        <table className="w-full text-[14px]">
          <thead>
            <tr className="bg-court-900/60 text-[12px] uppercase tracking-[0.1em] text-ink-500">
  ...
  if (!regular || regular.games === 0) {
    return (
      <div className="card p-5">
        ...
        <p className="mt-3 text-[14px] text-ink-500">데이터 없음</p>
      </div>
    );
  }
    ...
    <div className="card p-5">
      ...
      {playoff && playoff.games > 0 && (
        <div className="mt-4 rounded-md border border-court-700/60 bg-court-900/40 p-3">
          ...
          <div className="stat-num mt-1 text-[14px] text-ink-300">
...
function HustleStat({
  ...
  return (
    <div className="relative overflow-hidden rounded-md border border-court-700/60 bg-court-900/40 p-3">
      ...
      {subValue && <div className="mt-1 text-[12px] text-ink-300">{subValue}</div>}
    </div>
  );
}
  ...
  return (
    <div className="card p-5">
      ...
      {hasData ? (
          ...
          {qData.map((q) => {
            ...
            return (
              ...
              >
                ...
                <div className="stat-num text-right text-[14px]">
        ...
        <p className="mt-4 text-[14px] text-ink-500">쿼터별 데이터 없음</p>
      )}
  ...
  if (!row) {
    return (
      <div className="rounded-md border border-court-700/60 bg-court-900/40 p-3">
        ...
        <div className="stat-num mt-1 text-[15px] text-ink-500">—</div>
      </div>
    );
  }
  return (
    <div className="rounded-md border border-court-700/60 bg-court-900/40 p-3">
      ...
      <div className="stat-num mt-0.5 text-[13px] text-ink-300">
  ...
  return (
    <div className="card overflow-hidden">
      ...
      <div className="overflow-x-auto border-t border-court-700/60">
        <table className="w-full text-[14px]">
          <thead>
            <tr className="bg-court-900/50 text-[12px] uppercase tracking-[0.1em] text-ink-500">
...
function BigAdvCard({
  ...
  return (
    <div className="relative overflow-hidden card p-4">
      <span className={`absolute left-0 top-0 h-full w-[3px] ${color}`} />
      <div className="text-[13px] font-medium uppercase tracking-[0.12em] text-ink-500" title={hint}>
        {label}
      </div>
          ...
          <div className="flex flex-wrap gap-1">
            {PRESETS.map((p) => (
              <button
                ...
                className="rounded-md border border-court-700 bg-court-800/50 px-2.5 py-1 text-[13px] text-ink-300 transition hover:border-flame-500/50 hover:text-flame-400"
              >
                {p.label}
              </button>
            ))}
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        <span className="text-[13px] font-medium uppercase tracking-[0.12em] text-ink-300">
          {label}
      ...
      <div className="mt-2 flex flex-wrap items-center gap-1.5">
        ...
        <button
          ...
          disabled={!enabled}
          className="ml-1 rounded-md border border-court-700 bg-court-800/30 px-2 py-1 text-[12px] text-ink-400 hover:border-court-500 hover:text-ink-100 disabled:opacity-50"
        >
          전체
        </button>
        <button
          ...
          disabled={!enabled}
          className="rounded-md border border-court-700 bg-court-800/30 px-2 py-1 text-[12px] text-ink-400 hover:border-buzzer-500/50 hover:text-buzzer-400 disabled:opacity-50"
        >
          비움
        </button>
      </div>
...
function TeammatesPanel({
  ...
  return (
    <div className="card p-5">
      ...
      <p className="mt-1 text-[13px] text-ink-500">{teamShort} 소속, 클릭으로 이동</p>

      <div className="mt-4 divider-y">
        {teammates.length === 0 && (
          <div className="py-4 text-[14px] text-ink-500">동료 데이터 없음</div>
        )}
        {teammates.map((t) => (
          <a
            key={t.playerNo}
            href={`/players/${t.playerNo}`}
            className="flex items-center justify-between py-2.5 text-[15px] transition hover:text-flame-400"
          >
  ...
  return (
    <div className="card overflow-hidden">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-[14px]">
          <thead>
            <tr className="text-[12px] uppercase tracking-[0.1em] text-ink-500">
