...
export function TeamClutchCompare({
  ...
  return (
    <div className="card p-5">
      ...
      {/* 헤더 */}
      <div className="mb-2 grid grid-cols-[110px_70px_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)] gap-3 px-1 text-[10px] uppercase tracking-wider text-ink-500">
        <span>팀</span>
      ...
      <div className="space-y-2">
        {rows.map((r) => {
          ...
          return (
            ...
            >
              <span className="flex items-center gap-2 truncate text-[13px] font-medium text-ink-100">
                <span className="h-2 w-2 shrink-0 rounded-full" style={{ backgroundColor: color }} />
                {r.team.name}
              </span>
              <span className="stat-num text-right text-[12px] text-ink-300">
