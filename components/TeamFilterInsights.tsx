      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
        {cards.map((c, i) => (
          ...
          >
            ...
            />
            <div className="text-[13px] uppercase tracking-[0.1em] text-ink-500">
              {c.label}
            </div>
            <div className="mt-1.5 text-[16px] font-semibold text-ink-50">
              {c.team.name}
            </div>
            <div
              className={[
                "stat-num mt-1 text-[15px] font-medium",
                c.tone === "up"
                  ? "text-hoop-400"
                  : c.tone === "down"
                    ? "text-buzzer-400"
